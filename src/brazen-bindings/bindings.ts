...
export interface IBindingAccessor<T> {
  getBinding(): Binding<T>
}

export abstract class Binding<T> implements IBindingAccessor<T>, IBinding {
...
export class BindingBuilder<T> implements IBindingAccessor<T> {
